...
```bash
scripts/evaluation/run_ensemble_weight_optimization.sh
```

Custom config execution:

```bash
scripts/evaluation/run_ensemble_weight_optimization.sh configs/ensemble_weight_optimization/exclusive/bank_2.toml
```
